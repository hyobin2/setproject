...
public class ComCrossSiteHndlr extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		//System.out.println("ComComCrossSiteFilter> ============================");
		try {
			// print value if available; otherwise, try 'default'
			if (value != null) {
				//System.out.println("ComComCrossSiteFilter> =value");
				String sWriteEscapedXml = getWriteEscapedXml();
				//System.out.println("ComComCrossSiteFilter sWriteEscapedXml>" + sWriteEscapedXml);
				...
				//System.out.println("ComComCrossSiteFilter def> ="+def);

				// if we do have 'default', print it
				if (def != null) {
					// good 'default'
					out(pageContext, escapeXml, def);
				//System.out.println("ComComCrossSiteFilter> ="+def);
				}
				return SKIP_BODY;
			}
	...
	public int doEndTag() throws JspException {
		try {
			//System.out.println("ComComCrossSiteFilter ==== doEndTag");
			if (!needBody){
			...
			if (bodyContent != null && bodyContent.getString() != null){
				...
				//System.out.println("ComComCrossSiteFilter> end");
				//System.out.println("ComComCrossSiteFilter sWriteEscapedXml > sWriteEscapedXml");
    ...
    public static void main(String[] args) throws IOException
    {
    	...
    	ComComCrossSiteHndlr egovComCrossSiteHndlr = new ComComCrossSiteHndlr();
