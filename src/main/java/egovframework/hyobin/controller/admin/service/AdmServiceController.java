 ...
 */
package egovframework.hyobin.controller.admin.service;
 ...
 * @Description : ServiceController Class
...
@Controller
@RequestMapping(value = AdmServiceController.PREFIX)
public class AdmServiceController {

	public static final String PREFIX = "/adm/service";
