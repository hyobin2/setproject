 ...
 */
package egovframework.hyobin.controller.front.customer;
...
@Controller
@RequestMapping(value = CustomerController.PREFIX)
public class CustomerController {

	public static final String PREFIX = "/front/sub/cummunity/customercase";
	public static final String B_CODE = GlobalsProperties.getProperty("Bbs.customer");
	public static final String FILE_UPLOAD_PATH = GlobalsProperties.getFileProperty("customer.Path");
	/** BoardService */
