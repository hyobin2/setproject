 ...
 */
package egovframework.hyobin.controller.front.service;
...
@Controller
@RequestMapping(value = ServiceController.PREFIX)
public class ServiceController {

	public static final String PREFIX = "/front/sub/customer/service";
