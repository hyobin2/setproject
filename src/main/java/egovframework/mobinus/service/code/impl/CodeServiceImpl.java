package egovframework.mobinus.service.code.impl;
...
public class CodeServiceImpl extends EgovAbstractServiceImpl implements CodeService {
	 ...
	 * @exception Exception
	 */
	public String selectNm(String code) throws Exception {
		return codeMapper.selectNm(code);
	}
	...
	public int updateHit(Map<String, Object> map) throws Exception {
		return codeMapper.updateHit(map);
	}
