 ...
 */
package egovframework.mobinus.controller.ko.reference.futurefit;
...
@Controller
@RequestMapping(value = KoFutureFitController.PREFIX)
public class KoFutureFitController {

	public static final String PREFIX = "/ko/reference/futurefit";
