 ...
 */
package egovframework.mobinus.controller.admin.now;
...
@Controller
@RequestMapping(value = AdmNowController.PREFIX)
public class AdmNowController {

	public static final String PREFIX = "/adm/now";
	public static final String B_CODE = GlobalsProperties.getProperty("Bbs.Now");
	public static final String FILE_UPLOAD_PATH = GlobalsProperties.getFileProperty("Now.Path");
