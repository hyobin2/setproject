 ...
 */
package egovframework.mobinus.controller.admin.reference.futurefit;
...
@Controller
@RequestMapping(value = AdmFutureFitController.PREFIX)
public class AdmFutureFitController {

	public static final String PREFIX = "/adm/reference/futurefit";
	public static final String B_CODE = GlobalsProperties.getProperty("Bbs.FutureFit");
	public static final String FILE_UPLOAD_PATH = GlobalsProperties.getFileProperty("FutureFit.Path");
