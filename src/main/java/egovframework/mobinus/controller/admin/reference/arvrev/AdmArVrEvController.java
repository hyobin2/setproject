 ...
 */
package egovframework.mobinus.controller.admin.reference.arvrev;
...
@Controller
@RequestMapping(value = AdmArVrEvController.PREFIX)
public class AdmArVrEvController {

	public static final String PREFIX = "/adm/reference/arvrev";
