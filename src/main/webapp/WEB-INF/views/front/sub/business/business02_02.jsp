			...
			<div id="contents">
				...
				<div class="business_wrap">
					...
					<div class="business_top">
						...
						<div class="img"><img src="/resources/front/img/img_business02_top.jpg" alt="전직지원서비스"/></div>
						<p>
					...
					<div class="business_cont" id="business_cont">
						<div class="tab four">
							<ul>
								...
								<li><a href="business02_03.do#business_cont">기업 전직 서비스</a></li>
								<li><a href="business02_04.do#business_cont">공공 전직 서비스</a></li>
							</ul>
						</div>
						<div class="cont">
							<div class="img">
								<img src="/resources/front/img/img_business02_02.png" alt="IDOL"/>
							</div>
							<div class="txt">
								<p>
									IDOL은 재직자 및 퇴직(예정)자들을 대상으로 총 240여 가지의 메뉴를 통해서 다양한 고객의 니즈에 최적화된 서비스를 제공함으로써 <br />
									재직자에게는 미래에 대한 불확실성을 구체화하여 만족도 및 직무에 대한 몰입도를 높이고 퇴직(예정)자에게는 성공적인 미래설계 및 전직에 대한 기회를 제공하는 <br />
									<span>“교육 전직 혼합형 전략 프로그램”</span>입니다.
								</p>
							</div>
						</div>
					</div>
