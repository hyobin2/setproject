<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
			...
			<div id="contents">
				...
				<div class="login_wrap">
					...
					<div class="findID_form">
						...
						<div class="tab">
							<ul>
								<li><a href="/front/sub/member/findID.do" class="on">아이디 찾기</a></li>
								<li><a href="/front/sub/member/findPW.do">비밀번호 찾기</a></li>
							</ul>
						</div>
						<div class="cont">
							<!-- 아이디 찾기 -->
			...
			<div class="pop_findID">
				<div class="inner">
					<h2>아이디찾기 결과</h2>
					<a href="#" class="close_pop_findID"><img src="/resources/front/img/btn_close03.png" alt="close" id="close"/></a>
					<div class="cont">
						<p id="findData">회원님의 아이디는 <strong id="find_Id"> </strong> 입니다.</p>
						<p id="nodata"class="nodata">일치하는 회원정보가 없습니다.</p>
						<div class="btn">
							<a href="/front/sub/member/findPW.do">비밀번호 찾기</a>
							<a href="/front/sub/member/login.do">로그인 하기</a>
						</div>
					</div>
				</div>
			</div>
...
/* 	$(document).ready(function(){
	...
	var params={'name':$('#name').val(),'tel':$('#tel').val()}
		$.ajax({
			url: "/front/sub/member/findIdProc.do",
			type: "post",
