<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
		...
		<div id="header">
			<div class="inner">
				<h1><a href="#"><img src="/resources/front/img/img_logo.png" alt="케이잡스"/></a></h1>
				<div class="lnb">
					<ul>
						<li><a href="#">회원가입</a></li>
						<li><a href="#">로그인</a></li>
		...
		<div class="fullmenu">
			<div class="inner">
				...
				<div class="fullmenu_list">
					<ul>
						<li>
							<a href="/front/sub/greetings.do">K·Jobs</a>
							<div class="fullmenu_list_sub">
								<ul>
									<li><a href="/front/sub/greetings.do">인사말</a></li>
									<li><a href="/front/sub/ideology.do">경영이념</a></li>
									<li><a href="/front/sub/history.do">회사연혁</a></li>
									<li><a href="/front/sub/organization.do">회사조직</a></li>
									<li><a href="/front/sub/cooperate.do">협력기관</a></li>
								</ul>
							</div>
						</li>
						<li>
