...
function fn_link_page(pageNo){
	...
	$('#baseForm').attr('action', '/ko/reference/futurefit/list.do');
	$('#baseForm').submit();
}
...
function fn_view(bIdx){
	...
	$.ajax({
        url: "/ko/reference/futurefit/view.do",
        type: "post",
            ...
            <div class="section reference_con">
                <div class="wrapper">
                    ...
                    <div class="refer_list_area">
                        <form name="baseForm" id="baseForm" method="get" action="/ko/reference/futurefit/list.do" >
