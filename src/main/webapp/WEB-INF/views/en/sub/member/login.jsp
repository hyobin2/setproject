...
<script>
	function fn_login(){
		$('#baseForm').attr('action', '/en/sub/member/loginProc.do');
		$('#baseForm').submit();
	}
</script>
			<div id="contents">
				...
				<div class="login_wrap">
					...
					<div class="login_form">
						...
						<div class="form">
						<form id="baseForm" name="baseForm" method="post" action="/en/sub/member/loginProc.do" >
							<ul>
							...
							<div class="findID">
								<a href="/en/sub/member/findID.do">아이디/비밀번호 찾기</a>
							</div>
						</form>
						</div>
					</div>
