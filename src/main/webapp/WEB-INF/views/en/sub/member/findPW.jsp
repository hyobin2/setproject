<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
			...
			<div id="contents">
				...
				<div class="login_wrap">
					...
					<div class="findID_form">
						...
						<div class="tab">
							<ul>
								<li><a href="/en/sub/member/findID.do">아이디 찾기</a></li>
								<li><a href="/en/sub/member/findPW.do" class="on">비밀번호 찾기</a></li>
							</ul>
						</div>
						<div class="cont">
							<!-- 비밀번호 찾기 -->
			...
			<!-- <div class="pop_findPW">
				<div class="inner">
					<h2>비밀번호찾기 결과</h2>
					<a href="#" class="close_pop_findPW"><img src="/resources/en/img/btn_close03.png" alt="close"/></a>
					<div class="cont">
						<p>회원님의 비밀번호는 <strong>dqwfwq!! </strong> 입니다.</p>
						<p class="nodata">일치하는 회원정보가 없습니다.</p>
						<div class="btn">
							<a href="/en/sub/member/findID.do">아이디 찾기</a>
							<a href="/en/sub/member/join.do">회원가입</a>
						</div>
					</div>
				</div>
			</div> -->
...
$('#findPw').click(function(){
	...
	var params={'findId':$('#findId').val(),'tel':$('#tel').val()}
		$.ajax({
			url: "/en/sub/member/findPwProc.do",
			type: "post",
