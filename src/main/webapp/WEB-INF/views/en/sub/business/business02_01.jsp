			...
			<div id="contents">
				...
				<div class="business_wrap">
					...
					<div class="business_cont" id="business_cont">
						<div class="tab four">
							<ul>
								<li><a href="business02_01.do#business_cont" class="on">Second Life Plan</a></li>
						...
						<div class="cont">
							<div class="img">
								<img src="/resources/en/img/img_business02_01.png" alt="Process"/>
							</div>
							<div class="txt">
								<p>
									Second Life Plan holds various programs for the second life plan after retirement. Through life plan, career development, social contribution activity, and other public social service activities, it can vitalize local communities and set the direction for the second life plan.
								</p>
							</div>
						</div>
					</div>
