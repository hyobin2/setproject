					...
					<div class="business_cont" id="business_cont">
						<div class="tab four">
							<ul>
								...
								<li><a href="business02_02.do#business_cont" class="on">IDOL</a></li>
						...
						<div class="cont">
							<div class="img">
								<img src="/resources/en/img/img_business02_02.png" alt="IDOL"/>
							</div>
							<div class="txt">
								<p>
									IDOL is “an educational job-change combined strategic program” to actualize the unnecessity of the future and encourage workers to focus on their satisfaction and job and provide retired or retirement-expected employees with an opportunity for the successful future plan and right position by offering the best services for a lot of needs via 240 types of menus in total for them.
								</p>
							</div>
						</div>
					</div>
