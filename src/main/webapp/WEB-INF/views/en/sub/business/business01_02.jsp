					...
					<div class="business_cont" id="business_cont">
						<div class="tab">
							<ul>
								...
								<li><a href="business01_02.do#business_cont" class="on">Youth to Tomorrow Savings</a></li>
						...
						<div class="cont">
							<div class="img">
								<img src="/resources/en/img/img_business01_02.png" alt="Youth to Tomorrow Savings"/>
							</div>
							<div class="txt">
								<p>
									Youth to Tomorrow Savings is an employment support service jointly operated by the Ministry of Employment and Labor and the Small and Medium Business Administration that encourages the young who already got a full-time job in a small and medium-size enterprise to serve long. Young workers qualified for deduction, business owners, and the government save deductible amount together and pay the matured amount with the addition of the compound interest to the employees who have served for more than two years as bonus.
								</p>
							</div>
						</div>
					</div>
