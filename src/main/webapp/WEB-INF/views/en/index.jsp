				...
				<div class="inner">
					<ul>
						<c:choose>
							...
							<c:otherwise>
								<li><a href="#" style="background-image:url(/resources/en/img/img_main_visual01.jpg);">메인 비주얼 1</a></li>
								<li><a href="#" style="background-image:url(/resources/en/img/img_main_visual02.jpg);">메인 비주얼 2</a></li>
								<li><a href="#" style="background-image:url(/resources/en/img/img_main_visual03.jpg);">메인 비주얼 3</a></li>
							</c:otherwise>
						</c:choose>
			...
			<div class="main_section01">
				<div class="inner">
					<div class="search">
						...
						<form name="baseForm" id="baseForm" method="get" action="/en/sub/incruit/list.do" >
							<ul>
								<li>
				...
				<div class="inner">
					<ul>
						<li>
							...
							<div class="img">
								<img src="/resources/en/img/img_main_service01.jpg" alt="전직지원서비스"/>
							</div>
						</li>
						<li>
							<div class="txt">
							...
							<div class="img">
								<img src="/resources/en/img/img_main_service02.jpg" alt="취업성공 패키지"/>
							</div>
						</li>
						<li>
							<div class="txt">
							...
							<div class="img">
								<img src="/resources/en/img/img_main_service03.jpg" alt="청년 내일 채움 공제"/>
							</div>
						</li>
						<li>
							<div class="txt">
							...
							<div class="img">
								<img src="/resources/en/img/img_main_service04.jpg" alt="교육컨설팅서비스"/>
							</div>
						</li>
						<li>
							<div class="txt">
							...
							<div class="img">
								<img src="/resources/en/img/img_main_service05.jpg" alt="MICE 사업"/>
							</div>
						</li>
					</ul>
