...
<script type="text/javascript">
	...
	function fn_write() {
		...
		$('#baseForm').attr('action', '/adm/reference/futurefit/proc.do');
		$('#baseForm').submit();
	...
	function fn_delete() {
		...
		$('#baseForm').attr('action', '/adm/reference/futurefit/delete.do');
		$('#baseForm').submit();
	}
    ...
    <div class="s_con_area">
      	...
      	<form name="baseForm" id="baseForm" method="post" action="/adm/reference/futurefit/proc.do" enctype="multipart/form-data" >
