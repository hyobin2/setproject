...
function fn_write(bIdx) {
	$('#bIdx').val(bIdx);
	$('#baseForm').attr('action', '/adm/reference/arvrev/write.do');
	$('#baseForm').submit();
}

function fn_link_page(pageNo){
	$('#pageIndex').val(pageNo);
	$('#baseForm').attr('action', '/adm/reference/arvrev/list.do');
	$('#baseForm').submit();
}
...
function fn_search_page(){
    ...
    <div class="s_con_area">
       	...
       	<form name="baseForm" id="baseForm" method="get" action="/adm/reference/arvrev/list.do" >
